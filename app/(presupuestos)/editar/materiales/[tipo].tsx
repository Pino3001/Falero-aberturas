...
import ModalAccesoriosSerie from '@/app/(diseños-sistema)/modales/ModalAccesoriosSerie';
...
import ModalEditPrecio from '@/app/(diseños-sistema)/modales/ModalEditPrecio';
import ModalSerie from '@/app/(diseños-sistema)/modales/ModalSerie';
import ModalColor from '@/app/(diseños-sistema)/modales/ModalColor';
import ModalEditarPuerta from '@/app/(diseños-sistema)/modales/ModalEditarPuerta';


type modalOption = {
    visible: boolean;
    tipo?: 'serie' | 'color' | 'preciosVarios' | 'accesorios' | 'cortina' | 'puerta' | 'Dolar';
    dataModalSerie: {
        serie: SerieOption;
                ...
                modal && modal.visible && (<>
                    ...
                    {modal.tipo === 'preciosVarios' && (
                        modal.dataModalPrecioM2?.vario?.nombre === preciosVariosEnum.manoDeObra ? (
                            ...
                            />
                        ) : modal.dataModalPrecioM2?.vario?.nombre === preciosVariosEnum.dolar ? (
                            <ModalEditPrecio
                                visible={true}
                                onDismiss={() => setModal((prevModal) => ({ ...prevModal, visible: false }))}
                                title={modal.dataModalPrecioM2.vario?.nombre || 'No hay nombre'}
                                inputLabel='Precio dolar'
                                affix='$'
                                initialValue={modal.dataModalPrecioM2.vario?.precio || 0}
                                onSave={handleSaveVario}
                            />
