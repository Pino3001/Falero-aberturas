                ...
                <DataTable style={{ width: '100%', backgroundColor: colors.primary, borderRadius: 6, overflow: 'hidden', }}>
                    ...
                    {perfiles.map((perfil, index) => (
                        <DataTable.Row key={index} style={[styles.row, , { backgroundColor: colors.surfaceVariant }]}>
                            <DataTable.Cell >
                                <Text style={[styles.cellText, { fontFamily: fonts.medium.fontFamily }]}>{perfil.nombre}</Text>
                            </DataTable.Cell>
                            <DataTable.Cell numeric >
                                <Text style={[styles.cellText, { fontFamily: fonts.numero.fontFamily }]}>{perfil.gramos_por_m} g</Text>
                            </DataTable.Cell>
                            <DataTable.Cell numeric>
                                <IconButton
                                    icon="pencil"
